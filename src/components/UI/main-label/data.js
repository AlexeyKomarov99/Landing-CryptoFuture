...
export const nameOne = [
    ...
    {id: 12, symbol: <R className='MainLabel__symbol-item' />},
    {id: 13, symbol: <Y className='MainLabel__symbol-item' />},
    {id: 14, symbol: <P className='MainLabel__symbol-item' />},
    {id: 15, symbol: <T className='MainLabel__symbol-item' />},
    {id: 16, symbol: <O className='MainLabel__symbol-item' />}
]

export const nameTwo = [
    {id: 21, symbol: <F className='MainLabel__symbol-item' />},
    {id: 22, symbol: <U className='MainLabel__symbol-item' />},
    {id: 23, symbol: <T className='MainLabel__symbol-item' />},
    {id: 24, symbol: <U className='MainLabel__symbol-item' />},
    {id: 25, symbol: <R className='MainLabel__symbol-item' />},
    {id: 26, symbol: <E className='MainLabel__symbol-item' />}
]